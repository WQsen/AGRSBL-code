%% 2023.2.19 
%% 2026.4.18
%% Paper: Qisen Wang, Hua Yu, Jie Li, et al."Adaptive Grid Refinement Method for DOA Estimation Via Sparse Bayesian Learning", IEEE Journal of Oceanic Engineering, accepted.
clear all
close all
...
%     AL=[ -7.63,3.25,10.32, 30.83];
    ...
    tstart1 = tic;
    %% AGR_SBL:
    [Source_power_re1,Azimuth1,~,iter,Noise_variance]=AGRSBL(Y,Azimuth_grid,grid_interval,Aa,f0,c,K); 
